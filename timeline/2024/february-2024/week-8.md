...
- Now that Google Analytics have been set up, Onyeka can start properly doing archives publicity
  ...
  - [effect] mayAffectOtherPeople
- It would be a good idea to hold a session as part of a Town Hall to share tips and tricks on making good meeting summaries. Details to be firmed up next meeting. Ese and Vanessa interested in working on it.
  - [effect] mayAffectOtherPeople
...
- [action] Google Analytics has been set up on the Archives GitBook - either André or Vanessa will check in 48 hrs (Friday 23rd) that it's working [assignee] André, Vanessa [due] 23 February 2024 [status] in progress
